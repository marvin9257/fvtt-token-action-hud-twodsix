...
# Token Action HUD for Twodsix (test)
...
3. In the Manifest URL field, paste: `https://raw.githubusercontent.com/marvin9257/fvtt-token-action-hud-twodsix/main/module.json`
4. Click **Install** next to the pasted Manifest URL

## Required Modules

**IMPORTANT** - Token Action HUD for Twodsix requires the [Token Action HUD Core](https://foundryvtt.com/packages/token-action-hud-core) module to be installed.
